...
public final class DiagnosisRepoImp implements com.cardio.physician.domain.diagnosis.DiagnosisRepo {
    ...
    kotlin.coroutines.Continuation<? super java.util.List<com.cardio.physician.domain.connection.ConnectionModel>> p1) {
        return null;
    }
    
    private final java.lang.Object updateCollectionIfMedDoesNotExist(java.lang.String name, com.cardio.physician.domain.diagnosis.MedicineModel medicineModel, kotlin.coroutines.Continuation<? super java.lang.Boolean> p2) {
        return null;
    }
