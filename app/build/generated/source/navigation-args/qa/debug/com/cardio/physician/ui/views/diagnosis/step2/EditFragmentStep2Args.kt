...
public data class EditFragmentStep2Args(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EditFragmentStep2Args {
      bundle.setClassLoader(EditFragmentStep2Args::class.java.classLoader)
      val __userId : String?
      ...
      return EditFragmentStep2Args(__userId)
    }
  }
}
