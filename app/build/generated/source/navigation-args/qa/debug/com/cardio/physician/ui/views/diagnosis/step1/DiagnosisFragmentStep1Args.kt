...
public data class DiagnosisFragmentStep1Args(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): DiagnosisFragmentStep1Args {
      bundle.setClassLoader(DiagnosisFragmentStep1Args::class.java.classLoader)
      val __userId : String?
      ...
      return DiagnosisFragmentStep1Args(__userId)
    }
  }
}
