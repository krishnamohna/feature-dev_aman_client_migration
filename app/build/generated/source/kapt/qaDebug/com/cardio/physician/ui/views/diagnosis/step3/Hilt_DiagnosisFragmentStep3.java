...
public abstract class Hilt_DiagnosisFragmentStep3<Binding extends ViewBinding> extends BaseDiagnosisFragment<Binding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiagnosisFragmentStep3_GeneratedInjector) this.generatedComponent()).injectDiagnosisFragmentStep3(UnsafeCasts.<DiagnosisFragmentStep3>unsafeCast(this));
    }
  }
