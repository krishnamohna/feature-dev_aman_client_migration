...
public abstract class Hilt_ForgotPasswordFragment extends BaseFragmentAuth implements GeneratedComponentManagerHolder {
  ...
  Hilt_ForgotPasswordFragment(int layoutResId) {
    super(layoutResId);
  }
