...
public abstract class Hilt_DiagnosisFragmentStep1<Binding extends ViewBinding> extends BaseDiagnosisFragment<Binding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiagnosisFragmentStep1_GeneratedInjector) this.generatedComponent()).injectDiagnosisFragmentStep1(UnsafeCasts.<DiagnosisFragmentStep1>unsafeCast(this));
    }
  }
