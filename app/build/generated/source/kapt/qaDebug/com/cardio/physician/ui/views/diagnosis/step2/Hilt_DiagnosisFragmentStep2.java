...
public abstract class Hilt_DiagnosisFragmentStep2<Binding extends ViewBinding> extends BaseDiagnosisFragment<Binding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiagnosisFragmentStep2_GeneratedInjector) this.generatedComponent()).injectDiagnosisFragmentStep2(UnsafeCasts.<DiagnosisFragmentStep2>unsafeCast(this));
    }
  }
