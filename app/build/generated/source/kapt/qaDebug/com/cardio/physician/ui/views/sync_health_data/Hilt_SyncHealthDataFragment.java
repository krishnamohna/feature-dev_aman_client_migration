...
public abstract class Hilt_SyncHealthDataFragment<Binding extends ViewBinding> extends BaseToolBarFragment<Binding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SyncHealthDataFragment_GeneratedInjector) this.generatedComponent()).injectSyncHealthDataFragment(UnsafeCasts.<SyncHealthDataFragment>unsafeCast(this));
    }
  }
