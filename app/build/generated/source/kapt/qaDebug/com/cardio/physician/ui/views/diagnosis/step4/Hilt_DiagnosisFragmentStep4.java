...
public abstract class Hilt_DiagnosisFragmentStep4<Binding extends ViewBinding> extends BaseDiagnosisFragment<Binding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DiagnosisFragmentStep4_GeneratedInjector) this.generatedComponent()).injectDiagnosisFragmentStep4(UnsafeCasts.<DiagnosisFragmentStep4>unsafeCast(this));
    }
  }
