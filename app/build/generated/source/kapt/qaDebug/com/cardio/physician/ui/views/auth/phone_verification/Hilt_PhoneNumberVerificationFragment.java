...
public abstract class Hilt_PhoneNumberVerificationFragment extends BaseFragmentAuth implements GeneratedComponentManagerHolder {
  ...
  Hilt_PhoneNumberVerificationFragment(int layoutResId) {
    super(layoutResId);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhoneNumberVerificationFragment_GeneratedInjector) this.generatedComponent()).injectPhoneNumberVerificationFragment(UnsafeCasts.<PhoneNumberVerificationFragment>unsafeCast(this));
    }
  }
