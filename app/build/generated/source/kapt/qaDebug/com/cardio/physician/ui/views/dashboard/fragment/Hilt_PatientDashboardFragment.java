...
public abstract class Hilt_PatientDashboardFragment<Binding extends ViewBinding> extends BaseToolBarFragment<Binding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PatientDashboardFragment_GeneratedInjector) this.generatedComponent()).injectPatientDashboardFragment(UnsafeCasts.<PatientDashboardFragment>unsafeCast(this));
    }
  }
