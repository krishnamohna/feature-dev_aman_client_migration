...
public class ActivityTutorialBindingImpl extends ActivityTutorialBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.viewPagerTutorial, 3);
        sViewsWithIds.put(R.id.dotContainer, 4);
        sViewsWithIds.put(R.id.tutorialSkip, 5);
        sViewsWithIds.put(R.id.btnGetStarted, 6);
        sViewsWithIds.put(R.id.imgNext, 7);
    }
    // views
    @Nullable
    ...
    private ActivityTutorialBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (com.tbuonomo.viewpagerdotsindicator.DotsIndicator) bindings[4]
