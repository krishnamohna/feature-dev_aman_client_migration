...
public abstract class Hilt_GetProfileFragment<Binding extends ViewBinding> extends BaseToolBarFragment<Binding> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((GetProfileFragment_GeneratedInjector) this.generatedComponent()).injectGetProfileFragment(UnsafeCasts.<GetProfileFragment>unsafeCast(this));
    }
  }
