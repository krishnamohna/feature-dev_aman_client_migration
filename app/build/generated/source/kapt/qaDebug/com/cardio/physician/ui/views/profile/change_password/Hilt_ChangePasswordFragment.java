...
public abstract class Hilt_ChangePasswordFragment extends BaseFragmentAuth implements GeneratedComponentManagerHolder {
  ...
  Hilt_ChangePasswordFragment(int layoutResId) {
    super(layoutResId);
  }
