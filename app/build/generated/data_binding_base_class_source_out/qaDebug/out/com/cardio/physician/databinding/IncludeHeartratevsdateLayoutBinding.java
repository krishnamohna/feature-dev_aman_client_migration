...
public final class IncludeHeartratevsdateLayoutBinding implements ViewBinding {
  @NonNull
  private final MaterialCardView rootView;

  @NonNull
  public final ConstraintLayout clHeartRateGraph;
  ...
  private IncludeHeartratevsdateLayoutBinding(@NonNull MaterialCardView rootView,
      @NonNull ConstraintLayout clHeartRateGraph, @NonNull TextView tvAvgValue,
      @NonNull TextView tvGraphLabel, @NonNull TextView tvHrLabel, @NonNull TextView tvXaxisTitle,
      @NonNull TextView tvYaxisTitle) {
    this.rootView = rootView;
    this.clHeartRateGraph = clHeartRateGraph;
  ...
  @NonNull
  public static IncludeHeartratevsdateLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static IncludeHeartratevsdateLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.include_heartratevsdate_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static IncludeHeartratevsdateLayoutBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.clHeartRateGraph;
      ConstraintLayout clHeartRateGraph = rootView.findViewById(id);
      if (clHeartRateGraph == null) {
        break missingId;
      }
      ...
      return new IncludeHeartratevsdateLayoutBinding((MaterialCardView) rootView, clHeartRateGraph,
