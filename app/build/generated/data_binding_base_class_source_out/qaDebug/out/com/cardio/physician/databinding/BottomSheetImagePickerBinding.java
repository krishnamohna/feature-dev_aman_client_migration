...
public final class BottomSheetImagePickerBinding implements ViewBinding {
  @NonNull
  ...
  private BottomSheetImagePickerBinding(@NonNull MaterialCardView rootView,
      @NonNull MaterialTextView tvAddImageLabel, @NonNull MaterialTextView tvPickImage,
      @NonNull MaterialTextView tvTakePic) {
  ...
  @NonNull
  public static BottomSheetImagePickerBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static BottomSheetImagePickerBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.bottom_sheet_image_picker, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static BottomSheetImagePickerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BottomSheetImagePickerBinding((MaterialCardView) rootView, tvAddImageLabel,
          tvPickImage, tvTakePic);
    }
