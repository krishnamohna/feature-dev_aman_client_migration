package com.cardio.doctor.ui.views.fitbit;
...
import com.cardio.doctor.databinding.ActivityRootBinding;
...
public class RootActivity extends AppCompatActivity implements AuthenticationHandler {
    ...
    public static void start(@NotNull DiagnosisActivity diagnosisActivity) {
        Intent intent=new Intent(diagnosisActivity,RootActivity.class);
        diagnosisActivity.startActivity(intent);
    }
}
