...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
  ...
  override fun processBitmap(bitmap: Bitmap?, graphicOverlay: GraphicOverlay,chipGroup: ChipGroup?) {
  ...
  override fun processImageProxy(image: ImageProxy, graphicOverlay: GraphicOverlay,chipGroup: ChipGroup) {
    val frameStartMs = SystemClock.elapsedRealtime()
    if (isShutdown) {
      return
    }
    ...
    return task
      .addOnSuccessListener(
        ...
        OnSuccessListener { results: T ->
          ...
          this@VisionProcessorBase.onSuccess(results, graphicOverlay,chipGroup)
  ...
  protected abstract fun onSuccess(results: T, graphicOverlay: GraphicOverlay,chipGroup: ChipGroup?)
