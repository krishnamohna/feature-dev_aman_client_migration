...
class EditUserProfileViewModel @Inject constructor(
    ...
    fun selectGender(parent: AdapterView<*>?, view: View?, pos: Int, id: Long) {
        parent?.let {
            ...
            if(gender.equals(parent.context.getString(R.string.select_gender), true)){
                gender=""
            }
    ...
    suspend fun validateFields(
        ...
        if (userType != null || userType == SignUpUserType.GOOGLE.name) {
                    ...
                    repository.firebaseAuth.currentUser?.let {
                        val user: HashMap<String, Any?> =
                            hashMapOf(
                                ...
                                FireStoreDocKey.DOB_PROFILE to dob,
                                ...
                                FireStoreDocKey.SEARCH_NAME_USER to getSearchName(firstName,lastName),
                                FireStoreDocKey.USER_TYPE to com.cardio.physician.ui.common.utils.Constants.USER_TYPE_PHYSICIAN
                            )
