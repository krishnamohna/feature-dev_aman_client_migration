...
import com.cardio.physician.ui.common.utils.DateUtilsKt;
import com.cardio.physician.domain.fitness.model.WeightModel;
import com.cardio.physician.ui.common.utils.DateFormat_;
...
public class Weight {
    ...
    private final SimpleDateFormat DATE_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US);
    ...
    public WeightModel toWeightModel() {
        return new WeightModel(getWeight().toString(), DateUtilsKt.formatDate(DateFormat_.DATE_FORMAT_YYYY_MMM_DD,date));
    }
}
